...
public class CharacterMovement : MonoBehaviour, ICharacterController
{
    ...
    {
        get { return isRunning ? RunSpeed : maxSpeed; }
    }
    public float RunSpeed = 8f; // Defina a velocidade de corrida
    ...
    public void UpdateVelocity(ref Vector3 currentVelocity, float deltaTime) {
        ...
        if(Motor.GroundingStatus.IsStableOnGround) {
            ...
            //animator.SetBool("parado", moveInput == Vector3.zero); 
            //essa animação ta dando certo, se algo ficar errado é só apagar o comentario de cima e apagar os códigos de baixo
            ...
            animator.SetBool("parado", !isRunning && moveInput == Vector3.zero);
    ...
    //testando a corrida //qualquer merda apaga
